...
add_filter( 'web_type_row_actions', 'true_duplicate_post_link', 10, 2);
 
// Добавляем ссылку дублирования поста для post_row_actions
add_filter( 'post_row_actions', 'true_duplicate_post_link', 10, 2 );

add_filter( 'works_row_actions', 'true_duplicate_post_link', 10, 2 );

add_filter( 'services_row_actions', 'true_duplicate_post_link', 10, 2);
