...
<?php if ($gallery_block_color == 'тёмный') { ?>dark<?php } ?>  
">
    <div class="container">
        <?php
        ...
        <ul class="gallery-block__list gallery-block-list d-grid">
            <?php if (have_rows('new_gallery_block', $page_id)):
                while (have_rows('new_gallery_block', $page_id)):
                    ...
                    $gallery_image_title = get_sub_field('gallery_image_title', $page_id);
                    $gallery_image_link = get_sub_field('gallery_image_link', $page_id);
                    ?>
