    ...
    <div class="container">
        ...
        <div class="cta-block__wrapper cta-wrapper d-grid align-items-start">
            <div class="cta-wrapper__form">
                <?php if (is_page('seostudio')) {
                    echo do_shortcode('[contact-form-7 id="51e8d96" title="Заказать seo"]');
                } else {
                    echo do_shortcode('[contact-form-7 id="0e1e3b6" title="Заказать сайт"]');
                }
                ?>
            </div>
                ...
                <div class="cta-wrapper__images cta-images">
                    <?php if ($cta_block_images['first']) { ?>
                        <figure class="cta-images__image first">
                            <img src="<?php echo $cta_block_images['first']['url']; ?>"
                                alt="<?php echo $cta_block_images['first']['alt']; ?>">
                        </figure>
                    <?php }

                    if ($cta_block_images['second']) { ?>
                        <figure class="cta-images__image second">
                            <img src="<?php echo $cta_block_images['second']['url']; ?>"
                                alt="<?php echo $cta_block_images['second']['alt']; ?>">
                        </figure>
                    <?php } ?>
                </div>
