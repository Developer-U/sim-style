<?php
/*
* Sidebar Web type / Сайдбар на странице Тип сайта
*/
...
?>
    ...
    <aside class="content">
        ...
        <ul class="sidebar__post sidebar-post">
            ...
            $query_sidebar_web_type = new WP_Query( $args_sidebar_web_type );        

            if ( $query_sidebar_web_type->have_posts() ) {
                while ( $query_sidebar_web_type->have_posts() ) {
                    $query_sidebar_web_type->the_post();
                    ?>                   
